...
function index() {
  return (
    <div className="min-w-screen min-h-screen grid place-items-center text-center py-20 px-3 sm:px-6 relative text-white">
      <Image src="/static/battle.svg" className="object-cover object-top" fill priority alt="Battle page background image"/>
      ...
      <div className="w-full h-full px-6 z-20 grid grid-cols-1 sm:grid-cols-1 max-w-2xl grid-rows-1 gap-10 bg-gray-900/40 p-3 rounded-lg">
        <Image
        ...
        <div className="z-20 flex flex-col gap-6 text-left items-start">
          <div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-2 gap-10 mb-6">
                <div className="flex bg-purple-800 p-4 rounded-xl border-4 border-gray-300 drop-shadow-[0_0_50px_lightgray]">
                  <p className="leading-tight text-sm font-gray-200 ">
              ...
              <div className="flex flex-col">
                <div className="mx-auto">
                  <Image src="/static/winner.png" height={200} width={400} alt="winner"/>
                </div>
                <div>
                  <p className="text-xs font-gray-300 leading-none">
                ...
                <div className="mx-auto">
                  <Image src="/static/loser.png" height={200} width={400} alt="loser"/>
                </div>
                <div>
                  <p className="text-xs font-gray-300 leading-none">
                    If you lose the fight, that&apos;s the end your tokens will be added to the game pool
                    and you leave the arena with your NFT.
                  </p>
                </div>
              </div>
            </div>
